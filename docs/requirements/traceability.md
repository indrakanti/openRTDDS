...
| ORT-INT-006 | Implemented | `rtps/data_message.hpp`, `tests/interop/emit_*.{c,cpp}`, `capture_data.py`, `vendor_packet_probe.cpp` | `test_capture_data.py`, `vendor-packets` CI job | — |
